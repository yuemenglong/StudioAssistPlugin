...
{
    [BepInPlugin("io.github.yuemenglong.assist", "StudioAssistPlugin", "1.0.0.0")]
    public class StudioAssistPlugin : BaseUnityPlugin
    {
        // Awake is called once when both the game and the plug-in are loaded
        void Awake()
        {
            UnityEngine.Debug.Log("YML Hello, world!");
        }
